...
void Server::readyRead()
{
    ...
    m_buffers[senderSocket].append(senderSocket->readAll());
    if(m_buffers[senderSocket].contains('\n') || m_buffers[senderSocket].contains('\r'))
    {
        QByteArray message = m_buffers[senderSocket].trimmed();
        message.append("\r\n");
