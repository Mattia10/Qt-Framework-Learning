...
void MainWindow::save(QString path)
{
    ...
    for(int i=0; i < ui->listWidget->count(); i++)
    {
        ...
        qDebug() << "item is: " << ui->listWidget->item(i)->text();
...
void MainWindow::createItem(Qt::CheckState state, QString name)
{
    ...
    item->setFlags(Qt::ItemIsEnabled | Qt::ItemFlag::ItemIsEditable | Qt::ItemFlag::ItemIsAutoTristate | Qt::ItemFlag::ItemIsUserCheckable |Qt::ItemFlag::ItemIsSelectable );
